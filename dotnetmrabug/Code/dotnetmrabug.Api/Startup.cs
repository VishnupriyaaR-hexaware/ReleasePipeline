using dotnetmrabug.Api.Installer;
using dotnetmrabug.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using dotnetmrabug.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace dotnetmrabug.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetmrabug V1");
        });
