...
using dotnetmrabug.Api.Filters;
using dotnetmrabug.BusinessServices.Installer;

namespace dotnetmrabug.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetmrabug API", Version = version + "-" + branch});
            });
