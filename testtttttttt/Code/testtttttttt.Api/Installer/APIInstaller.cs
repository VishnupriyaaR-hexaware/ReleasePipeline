...
using testtttttttt.Api.Filters;
using testtttttttt.BusinessServices.Installer;

namespace testtttttttt.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "testtttttttt API", Version = version + "-" + branch});
            });
