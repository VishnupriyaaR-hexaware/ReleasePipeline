using testtttttttt.Api.Installer;
using testtttttttt.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using testtttttttt.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace testtttttttt.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "testtttttttt V1");
        });
