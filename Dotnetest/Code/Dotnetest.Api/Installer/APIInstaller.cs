...
using Dotnetest.Api.Filters;
using Dotnetest.BusinessServices.Installer;

namespace Dotnetest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Dotnetest API", Version = version + "-" + branch});
            });
