using Dotnetest.Api.Installer;
using Dotnetest.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using Dotnetest.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace Dotnetest.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "Dotnetest V1");
        });
