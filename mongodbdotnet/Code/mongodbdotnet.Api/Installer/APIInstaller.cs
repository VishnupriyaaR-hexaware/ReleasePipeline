...
using mongodbdotnet.Api.Filters;
using mongodbdotnet.BusinessServices.Installer;

namespace mongodbdotnet.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mongodbdotnet API", Version = version + "-" + branch});
            });
