using mongodbdotnet.Api.Installer;
using mongodbdotnet.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using mongodbdotnet.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace mongodbdotnet.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "mongodbdotnet V1");
        });
